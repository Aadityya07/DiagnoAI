...
const Prism = ({
  ...
  useEffect(() => {
    ...
    const fragment = `
      ...
      uniform vec2  iResolution; uniform float iTime; uniform float uHeight;
      uniform float uBaseHalf; uniform mat3  uRot; uniform int   uUseBaseWobble;
    ...
    const resize = () => {
      const w = container.clientWidth || 1; const h = container.clientHeight || 1; renderer.setSize(w, h);
    ...
    const wX = 0.5; const wY = 0.5; const wZ = 0.5; const phX = 1; const phZ = 1;
